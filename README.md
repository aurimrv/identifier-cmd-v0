...
## Code version for 2026/1 course
...
This version of EvoSuite only works with JDK 1.8.0. You need to set the java to this version prior to generate test cases.

```bash
java -jar ./lib/evosuite-1.2.0.jar -generateMOSuite -projectCP target/classes -class identifier.Identifier -seed 2025
```
